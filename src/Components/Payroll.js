  ...
  return (
    <>
      <div className="rounded-[7px] bg-[#0A3B3A] mt-3 s18:mt-[20px]">
        <h3 className="p-3 s18:p-5 text-white text-sm md:text-base s18:text-lg font-medium leading-none rounded-[7px_7px_0px_0px] border border-solid border-lightwhiteborder bg-[#136459]">
