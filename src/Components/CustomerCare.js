...
const CustomerCare = () => {
  ...
  return (
    <>
      <div className="rounded-[7px] bg-white dark:bg-[#0A3B3A] mt-3 s18:mt-[20px]">
        <h3 className="p-3 s18:p-5 text-center text-darkblue dark:text-white text-sm md:text-base s18:text-[18px] font-medium leading-[100%] rounded-[7px_7px_0px_0px] border border-solid border-lightblack dark:border-lightwhiteborder bg-extralightblack dark:bg-[#136459]">
          Customer Care
        </h3>
