...
const Casino = () => {
  ...
  return (
    <>
      <div className="relative bg-[#F2F4F6] dark:bg-darkGreen pb-[70px] s15:pb-[100px]">
          ...
          <div className="grid grid-cols-12 gap-5 md:gap-3 s18:gap-5">
            ...
            <div className="max-md:hidden md:col-span-3 s15:col-span-2">
              <div className="w-full flex flex-col gap-[10px]">
                <div className="rounded-md bg-white dark:bg-[#0a3b3a] p-[10px_12px] s15:p-[10px_12px] s18:py-[17px] s18:px-5 flex gap-2 s15:gap-3">
                  <img
                    src={fire}
                    alt="fire"
                ...
                <div className="rounded-md bg-white dark:bg-[#0a3b3a] p-[10px_6px] s15:p-[10px] flex flex-col gap-1 s14:gap-2 s15:gap-[10px]">
                  ...
                  {categories.map((category) => (
                    <Link
                      ...
                      key={category.id}
                      className="rounded-md bg-white dark:bg-transparent dark:hover:bg-[#0F5149] hover:bg-yellow p-[4px_6px] 
                        ...
                        <span className="w-3 min-w-3 max-w-3 s15:w-4 s15:min-w-4 s15:max-w-4">
                          {category.image && (
                            <img
                              src={category.image}
                              alt={category.name}
                              className="object-contain w-4 h-4 dark:invert dark:group-hover:opacity-50"
                            />
                          )}
                        </span>
                        <p className="text-xs s15:text-sm font-normal !leading-none text-[#26262699] dark:text-white/60 dark:group-hover:text-white/50 capitalize">
                          {category.name}
                        </p>
                      </div>
                      {category.count !== null && (
                        <p className="text-xs s15:text-sm font-normal text-[#26262699] dark:text-white/60 dark:group-hover:text-white/50">
                          {category.count}
                        </p>
                      )}
                    </Link>
                ...
                <div className="rounded-md bg-white dark:bg-[#0a3b3a] p-[10px_6px] s15:p-[10px] flex flex-col gap-1 s14:gap-2 s18:gap-[10px]">
                  <p className="text-[#A3A3A3] dark:text-white text-xs font-normal">
                    Providers
                  </p>
            ...
            <div className="col-span-12 md:col-span-9 s15:col-span-7">
              <div className="flex flex-col gap-[10px] ">
                ...
                <div className="p-5 md:p-3 s15:p-5 bg-white dark:bg-[#0a3b3a] rounded-md shadow-inputshadow">
                  <Winners />
                  {/* search */}
            ...
            <div className="col-span-0 hidden s15:block s15:col-span-3">
              <div className="odd-conected">
                <div className="flex flex-col gap-5">
                  <div className="bg-white dark:bg-[#02191E] rounded-md overflow-hidden">
                    <div className="bg-darkblue dark:bg-[#136459] grid grid-cols-2">
                    ...
                    <div className="bg-white dark:bg-[#0A3B3A] px-[19px] pb-5">
                      ...
                      <div>
                        <input
                          ...
                          className="rounded-md border-[1px] border-black/20 dark:border-white/15 bg-[#0000000c] dark:bg-[#136459] placeholder:text-[#9CA3AF] dark:text-white dark:placeholder:text-white text-darkblue text-base font-normal p-[12px_16px] s15:p-[20px_22px] w-full"
                        />
                      </div>
      ...
      <div className="s15:hidden flex justify-center items-center fixed bottom-0 z-[9] left-[50%] translate-x-[-50%] w-full max-w-[428px] mx-auto rounded-[20px_20px_0px_0px] bg-[#2F425C] dark:bg-[#02191E] p-[30px_15px_12px] lg:p-[24px_15px_12px] s18:p-[40px_15px_25px]">
        <span
      ...
      <div className={`rounded-[7px] open-content ${isOpen ? "block" : "hidden"}`}>
        <div className="odd-conected overflow-auto max-h-[550px] block fixed bottom-[84px] lg:bottom-[74px] z-[9] max-w-[428px] mx-auto left-[50%] translate-x-[-50%] s15:hidden rounded-[7px] bg-white dark:bg-bluedarkmodecolor shadow-dashboardshadow w-full">
          <div className="bg-white dark:bg-[#24354E] rounded-md overflow-hidden">
            ...
            <div className="bg-white dark:bg-[#02191E] px-[19px] pb-5">
              <div className="pt-16 pb-[92px] text-center">
              ...
              <div>
                <input
                  type="text"
                  placeholder="Booking code"
                  className="rounded-md border-[1px] border-black/20 dark:border-white/15 bg-[#0000000c] dark:bg-[#136459] placeholder:text-[#9CA3AF] dark:text-white dark:placeholder:text-white text-darkblue text-base 
