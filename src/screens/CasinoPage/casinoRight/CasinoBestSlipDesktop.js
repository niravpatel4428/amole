  ...
  return (
    <>
      <div className="bg-charcoal rounded-md overflow-hidden">
        ...
        <div className="bg-teal px-[19px] pb-5">
          ...
          <div>
            <input
              ...
              className="rounded-md border border-white/15 bg-forestGreen text-white placeholder:text-white text-base font-normal p-[12px_16px] s15:p-[20px_22px] w-full"
            />
          </div>
