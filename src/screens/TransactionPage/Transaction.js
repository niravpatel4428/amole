    ...
    return (
        <>
            <div className='p-[10px_15px_40px] md:p-[10px_20px_40px] s16:p-[15px_30px_60px] s18:p-[20px_30px_100px]'>
                <div className="overflow-hidden shadow-dashboardshadow w-full max-w-[1780px] mx-auto bg-doubleextralightwhite rounded-[18px] md:rounded-[25px] border border-solid border-lightblueborder dark:border-[#0b905c26] dark:bg-[#0A3B3A]">
                    <div className='overflow-auto'>
                        <div className="min-w-[900px] flex flex-wrap items-center justify-between p-[20px_20px] md:p-[10px_37px] s16:p-[16px_37px] s18:p-[20px_37px] bg-lightbluebg rounded-[18px_18px_0px_0px] md:rounded-[25px_25px_0px_0px] border border-solid border-b-extrathinblack dark:bg-[#0b905c26] dark:border-[#0b905c26]">
                        ...
                        <table className="table-auto w-full min-w-[900px] text-sm text-left">
                            ...
                            <tbody>
                                {data.map((item, index) => (
                                    <tr
                                        key={index}
                                        className={`${index % 2 === 0 ? "bg-tableblue dark:bg-[#0b905c26]" : "bg-transparent"
