...
const Dashboard = () => {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-12 gap-5 md:gap-3 s18:gap-5">
            ...
            <div className="max-md:col-span-12 md:col-span-9 lg:col-span-10 s15:col-span-7">
              <div className="s18:ml-[-35px]">
                ...
                <div className="max-sm:overflow-hidden max-sm:mt-[5px] mt-3 s18:mt-[17px] rounded-[7px] bg-white dark:bg-[#0A3B3A] shadow-dashboardshadow">
                  {/* sports / Hrs icon TODAY THU FRI SAT SUN */}
                  <div className="rounded-[6px] bg-white dark:bg-[#0A3B3A] shadow-dashboardshadow">
                                                  ...
                                                  className={`odd-block cursor-pointer rounded-[6px] w-full py-3 md:py-2 s18:py-3  flex flex-col gap-[4px] border items-center justify-center 
                                                        ${
                                                          isSelected
                                                            ...
                                                            : "bg-[#F3F4F6] dark:bg-teal border-[#E5E7EB] dark:border-doubleextralightwhite"
                                                        }
                                                    `}
                                                  onClick={() =>
                                                    setSelectedOdd(odd)
            ...
            <div className="col-span-0 hidden s15:block s15:col-span-3">
              <div className="odd-conected rounded-[7px] bg-white dark:bg-teal shadow-dashboardshadow w-full">
                ...
                <span className="cursor-pointer border-solid border-b-[2px] border-b-extrathinblack dark:border-b-lightwhiteborder flex p-3 md:p-2 md:px-3 s18:p-3 bg-extralightblack dark:bg-[#0A3B3A] items-center gap-[12px] text-[#EF4444] text-sm font-medium leading-[128%]">
                ...
                <div className="p-[15px_15px_0px] md:p-[12px_12px_0px] s18:p-[15px_15px_0px]">
                  ...
                  <div className="rounded-[0px_0px_7px_7px] bg-bglightblue dark:bg-forestGreen p-[15px_15px_20px] md:p-[12px_12px_15px] s18:p-[15px_15px_20px] flex flex-col   gap-[10px] md:gap-2 s18:gap-[10px] -mx-[15px] md:-mx-[12px] s18:-mx-[15px]">
                    ...
                    <div className="flex gap-[9px] mt-[15px] md:mt-3 s18:mt-[15px]">
                      <Link
                        to="/"
                        className="inline-flex bg-darkblue text-yellow border-[2px] border-solid border-darkblue dark:border-white hover:bg-transparent  dark:hover:bg-transparent dark:hover:text-white hover:text-darkblue transition-all duration-[0.3s] dark:bg-white rounded-[7px] dark:text-darkblue 
      ...
      <div className="s15:hidden flex justify-center items-center fixed bottom-0 z-[9] left-[50%] translate-x-[-50%] w-full max-w-[428px] mx-auto rounded-[20px_20px_0px_0px] bg-[#2F425C] dark:bg-charcoal p-[30px_15px_12px] lg:p-[24px_15px_12px] s18:p-[40px_15px_25px]">
        <span
      ...
      <div className={`open-content ${isOpen ? "block" : "hidden"}`}>
        <div className="odd-conected rounded-[7px] overflow-auto max-h-[400px] block fixed bottom-[84px] lg:bottom-[74px] z-[9] max-w-[428px] mx-auto left-[50%] translate-x-[-50%] s15:hidden pt-5">
          <div className=" rounded-[7px] bg-white dark:bg-charcoal shadow-dashboardshadow w-full">
            ...
            <div>
              <span className="cursor-pointer border-solid border-b-[2px] border-b-extrathinblack dark:border-b-lightwhiteborder flex p-[12px] bg-extralightblack dark:bg-[#0A3B3A] items-center gap-[12px] text-[#EF4444] text-sm font-medium leading-[128%]">
                <img src={remove} alt="remove" />
                Remove all
              </span>
