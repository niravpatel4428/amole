      ...
      <div className="odd-conected rounded-[7px] bg-teal shadow-dashboardshadow w-full">
        ...
        <div className="p-[15px_15px_0px] md:p-[12px_12px_0px] s18:p-[15px_15px_0px]">
          ...
          <div className="flex gap-[5px] mt-[5px] md:mt-3 s18:mt-[5px]">
            ...
            <span className="flex justify-end p-[10px_14px] xl:p-[8px_12px] s18:p-[12px_14px] items-center w-full s18:h-[43px] rounded-[6px] text-lg text-base s18:text-lg font-semibold !leading-none s18:leading-[120%] text-yellow bg-forestGreen border-doubleextralightwhite">
              50
            </span>
          </div>
